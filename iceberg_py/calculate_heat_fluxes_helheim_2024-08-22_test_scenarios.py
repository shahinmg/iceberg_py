...
for u_rel, constant_tf in u_rel_tf_zip:
    ...
    op = '/media/laserglaciers/upernavik/iceberg_py/outfiles/helheim/berg_model/2024-08-22_bergs_v2.pkl'
    ...
    gdf_pkl_path = '/media/laserglaciers/upernavik/iceberg_py/outfiles/helheim/2024-08-22-icebergs_helheim_keel_depth.gpkg'
    ...
    op = f'/media/laserglaciers/upernavik/iceberg_py/outfiles/helheim/Qib/2024-08-22/coeff_{factor}_melt_rates/'
    if not os.path.exists(op):
        os.makedirs(op)
    
    Q_ib_ds.to_netcdf(f'{op}2024-08-22_high_helheim_coeff_{factor}_constant_tf_{constant_tf}_constant_UREL_{u_rel}.nc')
