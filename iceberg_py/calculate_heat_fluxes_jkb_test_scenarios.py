...
gdf_pkl_path = '/media/laserglaciers/upernavik/iceberg_py/outfiles/jkb/iceberg_geoms/dim_with_bin/1990-06-15_icebergs_jkb_keel_depth.gpkg'
...
out_file = f'{op_berg_model}1990-06-15_bergs_v2.pkl'
...
for u_rel, constant_tf in u_rel_tf_zip:
    ...
    date = gpd.pd.to_datetime('19900615')
    ...
    op = f'/media/laserglaciers/upernavik/iceberg_py/outfiles/jkb/Qib/1990-06-15/u_rel_{urel_str}_factor{factor}_melt_rates/'
    if not os.path.exists(op):
        os.makedirs(op)
    
    Q_ib_ds.to_netcdf(f'{op}1990-06-15_jkb_coeff_{factor}_constant_tf_{constant_tf}_constant_UREL_{u_rel}.nc')
