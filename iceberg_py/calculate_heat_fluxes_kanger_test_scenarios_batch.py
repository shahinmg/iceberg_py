...
gdf_pkl_path = '/media/laserglaciers/upernavik/iceberg_py/outfiles/kanger/iceberg_geoms/keel_depths/'
...
for berg_file in gdf_list:
    ...
    op_berg_model = '/media/laserglaciers/upernavik/iceberg_py/outfiles/kanger/berg_model/'
    ...
    tf_test = [5.16, 5.63, 6.1] # from histogram of TF from Slater
    ...
    for u_rel, constant_tf in u_rel_tf_zip:
        ...
        op = f'/media/laserglaciers/upernavik/iceberg_py/outfiles/kanger/Qib/{date_str}/u_rel_{urel_str}_factor{factor}_melt_rates/'
        if not os.path.exists(op):
            os.makedirs(op)
        
        Q_ib_ds.to_netcdf(f'{op}{date_str}_kanger_coeff_{factor}_constant_tf_{constant_tf}_constant_UREL_{u_rel}.nc')
