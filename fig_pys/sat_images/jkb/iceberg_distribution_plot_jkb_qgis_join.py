...
berg_path = '/media/laserglaciers/upernavik/iceberg_py/outfiles/jkb/iceberg_geoms/dims/'
os.chdir(berg_path)
...
for file in berg_list:
    ...
    op_df = f'/media/laserglaciers/upernavik/iceberg_py/outfiles/jkb/iceberg_geoms/dim_with_bin/{date}_icebergs_jkb_keel_depth.gpkg'
