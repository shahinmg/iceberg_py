...
s2_path = '/media/laserglaciers/upernavik/sentinel_2/kanger/S2B_MSIL1C_20170710T141009_N0205_R053_T25WES_20170710T141004.tif'
...
# op = '/media/laserglaciers/upernavik/iceberg_py/outfiles/kanger/20170710T141009_icebergs_kanger.pkl'
# with open(op,'wb') as handle:
#     pickle.dump(convex_hull_df2, handle, protocol=pickle.HIGHEST_PROTOCOL)

# op_df = '/media/laserglaciers/upernavik/iceberg_py/outfiles/kanger/20170710T141009_icebergs_kanger.gpkg'
