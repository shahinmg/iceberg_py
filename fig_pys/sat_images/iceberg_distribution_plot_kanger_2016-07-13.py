...
s2_path = '/media/laserglaciers/upernavik/iceberg_py/sam/rbg_images/kanger/2016-07-13.tif'

joined_path = '/media/laserglaciers/upernavik/iceberg_py/outfiles/kanger/iceberg_geoms/dim_with_bin/2016-07-13_icebergs_dims.gpkg'
...
fig.savefig(f'{op}kanger_2016-07-13.pdf',dpi=300,transparent=False,  bbox_inches='tight')