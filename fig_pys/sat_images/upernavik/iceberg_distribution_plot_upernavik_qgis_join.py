...
s2_path = '/media/laserglaciers/upernavik/iceberg_py/sam/rbg_images/upernavik/2023-09-15.tif'
...
berg_path = '/media/laserglaciers/upernavik/iceberg_py/outfiles/upernavik/iceberg_geoms/dim_with_bin/'
os.chdir(berg_path)
...
for file in berg_list:
    ...
    # op = f'/media/laserglaciers/upernavik/iceberg_py/outfiles/upernavik/iceberg_geoms/keel_depths/'
