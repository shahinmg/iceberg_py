...
cbar.ax.set_ylabel(r'Q$_{aw}$ (W)', fontsize=20)
cbar.ax.tick_params(labelsize=15) 

# ax.clabel(CS)
ax.set_xlabel('Ocean Thermal Forcing (C)', size=20)
ax.set_ylabel('Flushing Time (Days)', size=20)
ax.tick_params(axis='both', which='major', labelsize=15)
ax.set_title('Helheim Fjord', size=20)
...
fig.savefig(f'{op}helheim_fjord_Qaw_contour.pdf', dpi=300, transparent=True, bbox_inches='tight')
