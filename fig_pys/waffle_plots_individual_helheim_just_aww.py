...
data = pd.DataFrame(
    {
        'labels': ['Q$_{ib}$ unmodified', 'Q$_{ib}$ modified $^{*}$','Remaining Q$_{aww}$'],
        'Kanger': [1, kanger_ds.Qib.data/1e10, (kanger_ds.Qaww_high.data/1e10)-(kanger_ds.Qib.data/1e10)-1],
        'Helheim': [2, helheim_ds.Qib.data/1e10 - 2, (helheim_ds.Qaww_high.data/1e10)-(helheim_ds.Qib.data/1e10)-2]
        },
).set_index('labels')
...
fig = plt.figure(
    ...
    plots={
        312: {
            ...
            'title': {'label': 'Helheim Heat Budget', 'loc': 'left', 'fontsize': 30,'pad':20}
        },
    },
...
op = '/media/laserglaciers/upernavik/melange_heatsink_manuscript/figures/helheim_melange_heatsink_waffle.png'
