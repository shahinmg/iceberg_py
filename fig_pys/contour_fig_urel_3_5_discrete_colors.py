...
cbar = fig.colorbar(contour_smooth, cmap=cmap, norm=norm, boundaries=bounds, 
                    ax=axs, extend='max')

cbar.set_label('Q$_{ib}$ (GW)', fontsize=20)
...
axs.set_xlabel('Ice Volume Below Aww (km$^{3}$)',fontsize = 20)
axs.set_ylabel('Average Aww Temperature (c)', fontsize = 20)
...
# plt.savefig(f'{op}contour_factor_4_urel_035.png', dpi=300,transparent=True)
