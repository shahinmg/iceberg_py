...
data = pd.DataFrame(
    {
        ...
        'Kanger': [1, 0, (kanger_ds.Qaww_high.data/1e10)],
...
op = '/media/laserglaciers/upernavik/melange_heatsink_manuscript/figures/kanger_melange_heatsink_waffle_just_aww_lower.png'
