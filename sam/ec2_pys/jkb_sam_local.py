...
if __name__ == '__main__':
    ...
    date2use =pd.to_datetime('2015',utc=True)
    with open('/media/laserglaciers/upernavik/iceberg_py/sam/item_pkls/jkb_image_item_list.pkl', 'rb') as f:
    ...
    grid_path = '/media/laserglaciers/upernavik/iceberg_py/geoms/jkb/melange_3x8_grid_UTM22N.gpkg'
    ...
    for time in image_stac.time:
        ...
        with mem_raster(rgb_norm_raster, **profile_rgb) as ds:
            for i, geom in enumerate(grid.geometry): 
                ...
                out_name = f'{date}_jkb_{i}.tif'
                out_path = f"/opt/atlas/iceberg_segment/jkb/{date}"
