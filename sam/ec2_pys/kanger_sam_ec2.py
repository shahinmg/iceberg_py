...
if __name__ == '__main__':
    ...
    with open('/opt/atlas/iceberg_segment/pkls/kanger_image_item_list.pkl', 'rb') as f:
        helheim_stack_list = pickle.load(f)
    
    grid_path = '/opt/atlas/iceberg_segment/kanger/geoms/kanger_box_utm25N_v2.gpkg'
        ...
        with mem_raster(rgb_norm_raster, **profile_rgb) as ds:
            for i, geom in enumerate(grid.geometry): 
                ...
                if nim.ndim >1:
                    ...
                    out_name = f'{date}_kanger_{i}.tif'
                    out_path = f"/opt/atlas/iceberg_segment/kanger/{date}"
